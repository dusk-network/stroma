...
// enabling late-chunking or other context-aware strategies. The embed
// of Embedder makes the relationship explicit in the type system:
// every ContextualEmbedder is an Embedder, and the index's runtime
// type assertion from an Embedder value to a ContextualEmbedder is a
// superset upgrade rather than a separate disjoint implementation.
